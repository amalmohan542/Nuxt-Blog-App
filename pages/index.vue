...
const posts = ref(dummyPosts.slice(0, 10)); // Load initial 10 posts
...
const loadMorePosts = () => {
  ...
  setTimeout(() => {
    ...
    const morePosts = allPosts.value.slice(currentLength, currentLength + 10);
  ...
  <div>
    ...
    <div v-if="loading" class="text-center my-4">
      <div role="status">
        ...
        <span class="text-lg font-semibold ml-4 text-gray-500">{{
          $t("loadingMorePost")
        }}</span>
      </div>
    </div>
